...
class DUMP_OWNER:
    ...
    valid_io_user = lambda self, user_id, valids_id: self.valid_io_group(group_id=self.get_group(user_id), valids_id=valids_id)
    ...
    valid_line_user = lambda self, user_id, line_id: self.valid_line_group(group_id=self.get_group(user_id), line_id=line_id)
