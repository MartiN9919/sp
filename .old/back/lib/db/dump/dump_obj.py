...
class DUMP_OBJ:
    ...
    def to_id  (self, val): return self.get_rec(name=val)[DAT_SYS_OBJ.ID  ] if isinstance(val, str) else val
    def to_name(self, val): return self.get_rec(id  =val)[DAT_SYS_OBJ.NAME] if isinstance(val, int) else val
