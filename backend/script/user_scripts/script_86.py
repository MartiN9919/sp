...
def script_86(request, group_id):
	try:
		fc_geometries = feature_collection_by_geometry(group_id, 30, [35,36], [30303], {})
		fc_points = feature_collection_by_geometry(group_id, 25, [54,55,57,62], [50163], {})
