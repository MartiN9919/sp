...
def script_87(request, group_id):
	try:
		fc_geometries = feature_collection_by_geometry(group_id, 30, [28,29,30], [30303], {})
		fc_points = feature_collection_by_geometry(group_id, 25, [], [50163], {})
