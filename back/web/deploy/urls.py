...
urlpatterns = [
    ...
    path('map/', include('map.urls')),  # список url для страницы map
    path('graph/', include('graph.urls')),  # список url для страницы graph
    ...
    path('',                          RedirectView.as_view(url='/map')),   # ничего не найдено - переадресация
]
