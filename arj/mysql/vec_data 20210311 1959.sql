...
-- Дата скрипта: 11.03.2021 19:59:32
...
-- 
-- Вывод данных для таблицы sys_alert
--
INSERT INTO sys_alert VALUES
(1, 'Храните пароль в тайне!', 'error', 10, '', '', '', 1, 'Дежурное сообщение'),
(2, 'Второй тип сообщения', 'info', 30, '', '', 'level_gpk type_ord', 1, ''),
(9, 'Проверка связи!', 'warn', 0, '1', '1', '', 1, 'от пользователя с сайта'),
