...
from   lib.funConst import HOST, HOST_SHORT, HOST2HOST_SHORT, FILE_UNIT_ICON
from   lib.funSys   import strUnique #, packageValid
from   lib.funText  import textDigitsLast
