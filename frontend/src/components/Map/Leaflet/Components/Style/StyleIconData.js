const DATA = {
  ...
  'post_simple_inside': {
    ...
    svg: `
      <svg width={width} height={height} viewBox="0 0 57 100">
        <path style="fill:#fff;stroke:{color};stroke-width:4" d="M 2.3,100 V 4.3 L 51.6,42 2.3,42"/>
  ...
  'checkpoint_auto_inside': {
    ...
    svg: `
      <svg width={width} height={height} viewBox="0 0 320 74">
        <path style="fill:#fff;stroke:{color};stroke-width:4" d="M 3.8,72.6 46.7,3.5 96.6,72.5 Z"/>
  ...
  'checkpoint_simplified_inside': {
    ...
    svg: `
      <svg width={width} height={height} viewBox="0 0 320 74">
        <path style="fill:#fff;stroke:{color};stroke-width:4" d="M 3.8,71.2 45.3,3.5 93.7,71.1 Z"/>
